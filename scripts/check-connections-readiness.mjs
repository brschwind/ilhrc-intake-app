...
requireCondition(/CONNECTIONS_ENABLED && !CONNECTIONS_FIXTURES_ENABLED/.test(routerSource), "Production adapters must remain feature-gated.");
...
const sourceFiles = trackedFiles.filter((file) => file.startsWith("src/") && /\.(js|jsx)$/.test(file));
